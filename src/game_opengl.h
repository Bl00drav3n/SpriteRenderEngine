...
GL_MACRO(glLoadMatrixf, void, const GLfloat * m);
...
GL_MACRO(glLoadIdentity, void, void);
GL_MACRO(glMatrixMode, void, GLenum mode);
GL_MACRO(glBegin, void, GLenum mode);
GL_MACRO(glEnd, void, void);
GL_MACRO(glVertex2fv, void, const GLfloat * v);
GL_MACRO(glTexCoord2fv, void, const GLfloat * v);
GL_MACRO(glVertex2f, void, GLfloat x, GLfloat y);
GL_MACRO(glColor3f, void, GLfloat red, GLfloat green, GLfloat blue);
GL_MACRO(glTexCoord2f, void, GLfloat s, GLfloat t);
GL_MACRO(glColor4fv, void, const GLfloat * v);
...
GL_MACRO(glVertexPointer, void, GLint size, GLenum type, GLsizei stride, const GLvoid * pointer);
